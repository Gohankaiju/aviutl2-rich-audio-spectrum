...
2. `rich-audio-spectrum` フォルダを **フォルダごと** 以下へ配置

```
C:\ProgramData\aviutl2\Script\rich-audio-spectrum\
```

3. AviUtl2 を起動(更新時は再起動)

必須ファイル: `rich-audio-spectrum.obj2` と `ras_*.lua` 4本。フォルダ名・ファイル名は変更しないでください。
